...
**Note:** Not a single state requiring ID verification offers healthcare, food assistance, or EITC to illegal immigrants—0% vs 50% of no-ID states that offer at least one of these three. The only overlap is cash assistance (22% of ID-required states).
